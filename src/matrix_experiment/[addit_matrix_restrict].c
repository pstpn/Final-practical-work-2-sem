// Сложение квадратных матриц с использованием слова restrict
...
void addit_matrix(double f_matrix[restrict][MAX_SIZE], 
double s_matrix[restrict][MAX_SIZE], 
double new_matrix[restrict][MAX_SIZE], 
size_t n, int alpha)
{
    for (size_t i = 0; i < n; i++)
    {
